...
const routes = [
  ...
  defineRoute({ capabilityId: "files", id: "assets-schema-menu", parentId: "engineering-assets", path: "/projects/:projectId/assets/schemas-menu", type: "submenu" }),
  defineRoute({ capabilityId: "files", id: "schema-assets", owns: ["asset-schema-catalog", "asset-schema-usage", "asset-schema-validation"], parentId: "assets-schema-menu", path: "/projects/:projectId/assets/schemas", surface: "asset-surface" }),
