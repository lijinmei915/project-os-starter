...
const assetSpecs = {
  ...
  "report-artifacts": { title: "执行证据", description: "管理任务执行与验收形成的可追溯记录。", sources: [".project-os/runs/", ".project-os/goal-validation-report.json"], sections: [["证据目录", "每次受控执行和验收都保留独立记录。"], ["证据用途", "证据用于追溯写入、审批、检查和最终结论。"], ["保留边界", "运行证据不替代当前项目状态和交接记录。"]] },
